...
<div class="fixed">
	<div class="nav"><h1>当前操作 : 每日一图</h1></div>
</div>
<!-- <div class="ishere">当前位置：<?php echo ($here); ?></div> -->
<div class="tab">
	<form action="<?php echo U('Admin/Photo/dsave');?>" method="post" enctype="multipart/form-data">
	...
	<tr>
		<td colspan="2">
		<input type="hidden" name="dayphoto" value="1" />
