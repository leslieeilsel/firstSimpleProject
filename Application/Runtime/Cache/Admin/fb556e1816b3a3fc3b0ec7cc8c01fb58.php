...
<div class="fixed">
	<div class="nav"><h1>点击排行</h1></div>
</div>
<div class="tab">
	
	<form action="/Holland/NG-ThinkPHP/index.php/Admin/Hot/saveOrder" method="post">
	<table style="width:100%" class="table">
		...
		<?php if(is_array($hot)): foreach($hot as $key=>$v): ?><tr>
			...
			<th><?php echo ($v["clicknum"]); ?></th>
			
			<th><?php echo ($v["ip"]); ?></th>
			
			<th><?php echo ($v["clicktime"]); ?></th>
