...
<body>
<div class="head">
	<a href=""><img src="/Holland/NG-ThinkPHP/Public/admin/images/logo.png" alt="进入前台页面" title="进入前台页面"/></a>
</div>
...
<div class="tab">
	<form action="<?php echo U('Admin/Dayone/usave');?>" method="post" enctype="multipart/form-data">
	<table width=100% class="table">
		...
		<tr>
			...
			<img src="/Holland/NG-ThinkPHP/Public/upload/dayone/<?php echo ($arr["imagename"]); ?>" alt="" width="150px" height="150px"/></td>
		</tr>
		<tr>
			<th>内容:</th>
