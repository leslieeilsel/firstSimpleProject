...
<div class="fixed">
	<div class="nav"><h1>修改图文</h1></div>
</div>
<!-- <div class="ishere">当前位置：</div> -->
<div class="tab">
	<form action="<?php echo U('Admin/Photo/usave');?>" method="post" enctype="multipart/form-data">
	<table width=100% class="table">
		...
		<tr>
			...
			<img src="/Holland/NG-ThinkPHP/Public/upload/<?php echo ($arr["imagename"]); ?>" alt="" width="150px" height="150px"/></td>
		</tr>
		<tr>
			<th>摘要:</th>
			<td><textarea name="summary" style="height:75px;width:45%;"><?php echo ($arr["summary"]); ?></textarea></td>
		</tr>
		<tr>
			<th>内容:</th>
...
<script type="text/javascript">
	document.getElementById("cateid").value="<?php echo ($arr["fcid"]); ?>|<?php echo ($arr["cateid"]); ?>";
</script>
			</div>
		</div>
	</div>
