...
<div class="national" style="width:100%;">
	...
	<div class="content clear">
		...
		<div class="R">
			<div class="main">
			<div class="fixed">
	<div class="nav"><h1>管理员列表</h1></div>
	<div class="search">
	</div>
</div>
<div class="tab">
	
	<form action="/Holland/NG-ThinkPHP/index.php/Admin/Admin/saveOrder" method="post">
	<table style="width:100%" class="table">
		...
		<?php if(is_array($arr)): foreach($arr as $key=>$v): ?><tr>
			...
			<th><?php echo ($v["password"]); ?></th>
			
			<th>
				<a href="/Holland/NG-ThinkPHP/index.php/Admin/Admin/update/id/<?php echo ($v["id"]); ?>"><img src="/Holland/NG-ThinkPHP/Public/admin/images/rewrite.png" alt="修改" title="修改" width="23px"/></a>&nbsp;&nbsp;
				<a href="/Holland/NG-ThinkPHP/index.php/Admin/Admin/del/id/<?php echo ($v["id"]); ?>/deleted/1" onClick="delcfm()"><img src="/Holland/NG-ThinkPHP/Public/admin/images/delete.png" alt="删除" title="删除" width="23px"/></a>
			</th>
