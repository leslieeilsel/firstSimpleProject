...
<div class="search">
	<form method="get" action="<?php echo U('Admin/Photo/recycle');?>">
...
<div class="tab">
	<table style="width:100%" class="table">
		...
		<?php if(is_array($arr)): foreach($arr as $key=>$v): ?><tr>
			...
			<th>
				<a href="/Holland/NG-ThinkPHP/index.php/Admin/Photo/back/id/<?php echo ($v["id"]); ?>/deleted/0" onClick="backcfm()"><img src="/Holland/NG-ThinkPHP/Public/admin/images/back.png" alt="撤回" title="撤回" width="23px"/></a>&nbsp;&nbsp;
				<a href="/Holland/NG-ThinkPHP/index.php/Admin/Photo/delete/id/<?php echo ($v["id"]); ?>" onClick="delcfm()"><img src="/Holland/NG-ThinkPHP/Public/admin/images/delete.png" alt="彻底删除" title="彻底删除" width="23px"/></a>&nbsp;&nbsp;
				<?php if($v["recommend"] == 1): ?><a href="#"><img src="/Holland/NG-ThinkPHP/Public/admin/images/down.png" alt="取消推荐" title="取消推荐" width="23px"/></a>
				<?php elseif($v["recommend"] == 0): ?>
					<a href="#"><img src="/Holland/NG-ThinkPHP/Public/admin/images/up.png" alt="推荐" title="推荐" width="23px"/></a><?php endif; ?>
			</th>
		</tr>
		<script type="text/javascript">
	...
	<table class="submit">
	<tr>
		<td colspan="2"><a href="/Holland/NG-ThinkPHP/index.php/Admin/Photo/deleteAll" onClick="delallcfm()"><input type="submit" value="清空回收站" id="submit"/></a></td>
	</tr>
	</table>
</div>
